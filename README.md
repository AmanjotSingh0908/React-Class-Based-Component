Class-based components extend the React.Component class and provide access to features such as state and lifecycle methods like componentDidMount, componentDidUpdate, and componentWillUnmount.
